...
- `archility/setup.sh` is the shared local bootstrap for PlantUML, Draw.io, Graphviz-backed PlantUML support, and related system prerequisites.
...
- Current toolchain names surfaced by the audit include `plantuml`, `drawio`, `inkscape`, and `mermaid`.
